...
public class EditionButton extends Button
{
	public EditionButton(HangmanPro game,Edition editionToStart, double x, double y, double width, double height, String text) 
	{
		...
		mouseListener = new MouseListener()
		{
			...
			public void mouseClicked(MouseEvent e)
			{
				...
				try 
				{			
					  new Thread(() -> { game.Setup(editionToStart); }).start();
				} 
				catch (Exception ex) { }
			}
		};
